...
try {
  ...
  // Notice NO template literals or complicated escapes. Just safe string concatenation.
  const newScriptAvatar = "if (isUser) { avatar.textContent = '👤'; } else { avatar.style.padding = '0'; avatar.style.overflow = 'hidden'; avatar.innerHTML = '<img src=\"anmol-ai-profile.jpeg\" style=\"width:100%; height:100%; object-fit:cover;\">'; }";
